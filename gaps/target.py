...
class Target(object):
    """
    A Target is a resource generated by a :py:class:`~gaps.task.Task`.
    ...
    Typically, a :py:class:`~gaps.task.Task` will define one or more Targets as output, and the Task
...
class FileSystem(object):
    ...
    def mkdir(self, path, parents=True, raise_if_exists=False):
        ...
        :param bool parents: Create parent directories when necessary. When
                             ...
                             exist, raise gaps.target.MissingParentDirectory
        :param bool raise_if_exists: raise gaps.target.FileAlreadyExists if
                                     the folder already exists.
        """
        raise NotImplementedError("mkdir() not implemented on {0}".format(
    ...
    def isdir(self, path):
        ...
        *Note*: This method is optional, not all FileSystem subclasses implements it.
        """
        raise NotImplementedError("isdir() not implemented on {0}".format(
            self.__class__.__name__))
    ...
    def listdir(self, path):
        ...
        *Note*: This method is optional, not all FileSystem subclasses implements it.
        """
        raise NotImplementedError("listdir() not implemented on {0}".format(
            self.__class__.__name__))
    ...
    def move(self, path, dest):
        ...
        """
        raise NotImplementedError("move() not implemented on {0}".format(
            self.__class__.__name__))
    ...
    def copy(self, path, dest):
        ...
        """
        raise NotImplementedError("copy() not implemented on {0}".format(
            self.__class__.__name__))


class FileSystemTarget(Target):
    """
    Base class for FileSystem Targets like :class:`~gaps.local_target.LocalTarget` and :class:`~gaps.contrib.hdfs.HdfsTarget`.
    ...
    def temporary_path(self):
        ...
        _temp_path = '{}-gaps-tmp-{:010}{}'.format(slashless_path, num,
...
class AtomicLocalFile(io.BufferedWriter):
    ...
    :class:`gaps.local_target.LocalTarget` for example
    """
    def __init__(self, path):
    ...
    def generate_tmp_path(self, path):
        return os.path.join(tempfile.gettempdir(),
                            'gaps-s3-tmp-%09d' % random.randrange(0, 1e10))
