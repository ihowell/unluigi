...
"""
``gaps.date_interval`` provides convenient classes for date algebra.
Everything uses ISO 8601 notation, i.e. YYYY-MM-DD for dates, etc.
There is a corresponding :class:`gaps.parameter.DateIntervalParameter` that you can use to parse date intervals.

Example::

    class MyTask(gaps.Task):
        date_interval = gaps.DateIntervalParameter()
...
class DateInterval(object):
    ...
    Example::
       ...
       x = gaps.date_interval.Week(2013, 52)
       print x.prev()
